...
public static class UserTestData
{
    ...
    private static readonly Faker<User> UserFaker = new Faker<User>()
        ...
        .RuleFor(u => u.Password, f => $"pwd{f.Random.Number(100, 999)}")
    ...
    /// <summary>
    /// Generates a password that satisfies validation (non-empty, length ≥ 6).
    /// </summary>
    /// <returns>A valid password for tests.</returns>
    public static string GenerateValidPassword()
    {
        return $"pwd{new Faker().Random.Number(100, 999)}";
    }
    ...
    /// <summary>
    /// Generates a password that fails validation (shorter than minimum length).
    /// </summary>
    /// <returns>An invalid password for negative tests.</returns>
